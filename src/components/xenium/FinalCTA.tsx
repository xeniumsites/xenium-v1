...
export default function FinalCTA() {
  ...
  return (
    <section className="py-44 px-6 relative overflow-hidden" ref={ref}>
      ...
      <div className={`relative z-10 max-w-3xl mx-auto text-center transition-all duration-1000 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          ...
          <button
            ...
            className="glass-card text-foreground font-medium px-8 py-4 rounded-full hover:bg-muted/30 transition-all flex items-center gap-2 hover:border-xenium-violet-mid/40"
          >
            <Play size={16} />
