...
const audiences = [
  { icon: Heart, title: "Couples & Romantics", desc: "For love stories, proposals, and milestones that deserve more than words." },
  { icon: Users, title: "Families & Friends", desc: "For birthdays, tributes, and heartfelt celebrations of the people you love." },
  { icon: Briefcase, title: "Teams & Brands", desc: "For employee appreciation, retirements, and recognition that truly resonates." },
];
